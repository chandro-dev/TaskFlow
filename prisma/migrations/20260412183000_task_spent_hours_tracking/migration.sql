...
create or replace function public.create_project_task_with_notifications(
  ...
  target_spent_hours integer default 0,
...
begin
  ...
  if coalesce(target_spent_hours, 0) < 0 then
...
revoke all on function public.create_project_task_with_notifications(uuid, uuid, uuid, text, text, public.task_priority, public.task_type, date, integer, integer, uuid[], jsonb) from public;
grant execute on function public.create_project_task_with_notifications(uuid, uuid, uuid, text, text, public.task_priority, public.task_type, date, integer, integer, uuid[], jsonb) to authenticated;

drop function if exists public.update_project_task_details(
  uuid,
  uuid,
  uuid,
  uuid,
...
begin
  ...
  set
    ...
    spent_hours = coalesce(target_spent_hours, 0),
...
revoke all on function public.update_project_task_details(uuid, uuid, uuid, uuid, text, text, public.task_priority, public.task_type, date, integer, integer, uuid[], jsonb) from public;
grant execute on function public.update_project_task_details(uuid, uuid, uuid, uuid, text, text, public.task_priority, public.task_type, date, integer, integer, uuid[], jsonb) to authenticated;
